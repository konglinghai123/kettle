...
public class MetlTaskTiming extends BaseModel<MetlTaskTiming> {
    ...
    */
    public JobEntrySpecial getStartEntryByJobId(int jobId) throws KettleException {
    ...
    * @return SATRT控件实体
     * @throws KettleException 
    */
    public JobEntrySpecial getStartEntryByJobId(String dbCode,int jobId) throws KettleException {
